...
public class NewCostBalancerStrategy implements BalancerStrategy
{
  private static final EmittingLogger log = new EmittingLogger(NewCostBalancerStrategy.class);
  ...
  public NewCostBalancerStrategy(DateTime referenceTimestamp, int threadCount)
  {
